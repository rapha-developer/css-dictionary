...
export const propertiesStartWithRCourseInfo: CourseInfoProps = {
    ...
    body: {
        first: "Dentre as propriedades que você aprenderá estão: resize, right, rotate & row-gap.",
    ...
    curriculumDesc: "Esse curso foi construído com o intuito de entender minunciosamente cada propriedade css que começa com letra R. As propriedades, quando visualizadas com atenção, podem auxiliar desenvolvedores na resolução de desafios com a linguagem css.",
}