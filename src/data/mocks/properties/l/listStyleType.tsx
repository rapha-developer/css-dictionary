...
export default function ListStyleTypeTemplate({ name, value }: PropertyTemplateProps['property']) {
    const inheritValue = `circle`
    return (
        <div className="flex flex-col gap-4 px-4 py-6 w-full">
            <div className="w-full h-full px-2 md:px-4 py-3" style={{listStyleType: inheritValue}}>
                <ul className="px-2 py-3 bg-pink-200 rounded-md" style={{listStyle: 'inside', listStyleType: value}}>
