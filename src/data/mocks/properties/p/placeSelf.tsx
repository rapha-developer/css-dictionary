...
export default function placeItemsTemplate({ name, value }: PropertyTemplateProps['property']) {
    ...
    return (
        <div className="flex flex-col gap-4 px-4 py-6 w-full" style={{placeSelf: inheritValue}}>
            <div className="w-full h-80 border-4 border-dotted border-red-400 rounded-sm p-4 grid gap-1" 
            style={{gridTemplateColumns: 'repeat(3, 1fr)', 
                gridTemplateRows: 'repeat(3, 1fr)',
                placeItems: 'center',
                placeSelf: inheritValue}}>
                ...
                <div className="p-5 bg-green-300 rounded-md font-outfit text-secondary text-xl text-center"
                style={{placeSelf: value}}>5</div>
