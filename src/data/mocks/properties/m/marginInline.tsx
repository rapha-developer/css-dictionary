...
export default function MarginInlineTemplate({ name, value }: PropertyTemplateProps['property']) {
    const inheritValue = `2px`
    return (
        <div className="flex flex-col gap-4 px-4 py-6 w-full">
            <div className="w-full h-full rounded-md flex" style={{marginInline: inheritValue}}>
                ...
                style={{marginInline: value}}>2</div>
