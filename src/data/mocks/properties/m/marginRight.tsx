...
export default function MarginRightTemplate({ name, value }: PropertyTemplateProps['property']) {
    const inheritValue = `2px`
    return (
        <div className="flex flex-col gap-4 px-4 py-6 w-full">
            <div className="w-full h-full rounded-md flex" style={{marginRight: inheritValue}}>
