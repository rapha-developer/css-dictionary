...
export default function MarginInlineStartTemplate({ name, value }: PropertyTemplateProps['property']) {
    const inheritValue = `15px`
    return (
        <div className="flex flex-col gap-4 px-4 py-6 w-full">
            <div className="w-full h-full rounded-md flex" style={{marginInlineStart: inheritValue}}>
                ...
                style={{marginInlineStart: value}}>2</div>
