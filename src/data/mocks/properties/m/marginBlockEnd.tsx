...
export default function MarginBlockEndTemplate({ name, value }: PropertyTemplateProps['property']) {
    const inheritValue = `15%`
    return (
        <div className="flex flex-col gap-4 px-4 py-6 w-full">
            <div className="w-full h-full rounded-md" style={{marginBlockEnd: inheritValue}}>
                ...
                style={{marginBlockEnd: value}}>2</div>
