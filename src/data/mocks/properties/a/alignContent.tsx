...
export default function AlignContentTemplate({ name, value }: PropertyTemplateProps['property']) {
    return (
        <div className="w-full h-auto">
            <div className="bg-dark mx-auto w-3/4 h-64 py-4 px-2 rounded-md overflow-hidden relative">
                ...
                />
                <div className="absolute top-0 left-0 z-20 w-full h-full py-3 content-center">
