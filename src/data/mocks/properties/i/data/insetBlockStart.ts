...
export const insetBlockStartData: PropertyProps = {
    name: "inset block start",
    definition: "A propriedade inset-block-start define a distância entre o início de um elemento e o elemento pai na direção do bloco. Observação: para que esta propriedade tenha efeito, ela precisa ter a propriedade position especificada.",
