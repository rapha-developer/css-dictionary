...
export default function BorderStartStartRadiusTemplate({ name, value }: PropertyTemplateProps['property']) {
    const inheritValue = `25%`
    return (
        <div className="flex flex-col gap-4 py-4" style={{borderStartStartRadius: inheritValue}}>
            ...
            style={{borderStartStartRadius: value}}>
