...
export default function BorderBottomTemplate({ name, value }: PropertyTemplateProps['property']) {
    ...
    return (
        <div className="flex flex-col gap-4 py-4" style={{borderBottom: inheritValue}}>
            <div className="w-3/4 h-20 rounded-md mx-auto flex items-center justify-center"
            style={{borderBottom: value, writingMode: writeClass}}>
