...
export default function BorderTopTemplate({ name, value }: PropertyTemplateProps['property']) {
    const inheritValue = `2px dotted crimson`
    return (
        <div className="flex flex-col gap-4 py-4" style={{borderTop: inheritValue}}>
