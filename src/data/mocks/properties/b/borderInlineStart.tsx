...
export default function BorderInlineStartTemplate({ name, value }: PropertyTemplateProps['property']) {
    ...
    return (
        <div className="flex flex-col gap-4 py-4" style={{borderInlineStart: inheritValue}}>
            <div className="w-3/4 h-60 rounded-md mx-auto flex items-center justify-center"
            style={{borderInlineStart: value, writingMode: writeClass}}>
