...
export default function BorderInlineEndTemplate({ name, value }: PropertyTemplateProps['property']) {
    ...
    return (
        <div className="flex flex-col gap-4 py-4" style={{borderInlineEnd: inheritValue}}>
            <div className="w-3/4 h-60 rounded-md mx-auto flex items-center justify-center"
            style={{borderInlineEnd: value, writingMode: writeClass}}>
