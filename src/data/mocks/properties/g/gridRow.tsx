...
export default function GridRowTemplate({ name, value }: PropertyTemplateProps['property']) {
    return (
        <div className="flex flex-col gap-4 px-4 py-6 w-full" >
            <div className="w-full h-full grid gap-3 py-3 px-2 bg-pink-300 rounded-lg" style={{gridTemplateColumns: 'auto auto auto auto'}}>
                <div className="w-full h-full p-5 text-center text-xl bg-pink-200 rounded-lg" style={{gridRow: value}}>1</div>
